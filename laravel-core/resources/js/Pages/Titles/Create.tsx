...
const CreateTitle: React.FC<PageProps> = ({auth, menu}) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();
        setCreating(true);
        titlesGroupForm.post(route('titles.store'), {
            onSuccess: () => {
                toast.success('Group of titles has been created successfully');
                router.get(route('titles.index'));
            },
            onError: (error) => {
                toast.error('Error creating the group of titles');
    ...
    return (<>
        <Head title="Create a group of titles" />
        <Webmaster
            user={auth.user}
            menu={menu}
            breadcrumb={<>
        ...
        >
        <Page title="Create a group of titles" header={<></>}>
