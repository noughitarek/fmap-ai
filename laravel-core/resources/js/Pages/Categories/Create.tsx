import { FacebookCategory, PageProps, Wilaya } from "@/types";
...
const CreateCategory: React.FC<PageProps<{facebookCategories: FacebookCategory[]}>> = ({auth, menu, facebookCategories}) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();
        setCreating(true);
        categoriesGroupForm.post(route('categories.store'), {
            onSuccess: () => {
    ...
    return (<>
        <Head title="Create a group of categories" />
        <Webmaster
            user={auth.user}
            menu={menu}
            breadcrumb={<>
        ...
        >
        <Page title="Create a group of categories" header={<></>}>
